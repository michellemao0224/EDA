...
loan.income_by_amount <- loan %>%
  ...
  summarise(mean_LoanOriginalAmount = 
...
ggplot(aes(x = IncomeRange, y = mean_LoanOriginalAmount),
       data = subset(loan.income_by_amount, 
                     !is.na(IncomeRange))) +
...
loan.di_by_income_rate.wide <-
  subset(loan.di_by_income_rate[c('IncomeRange', 
                                  'ProsperRating..Alpha.', 
                                  'median_BorrowerAPR')],
...
pr1 <- ggplot(aes(x = IncomeRange, y = AA / A), 
       data = subset(loan.di_by_income_rate.wide, 
                     !is.na(IncomeRange) & 
                       IncomeRange != 'Not displayed')) +
