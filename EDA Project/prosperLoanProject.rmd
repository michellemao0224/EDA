...
ggplot(aes(x = LoanOriginationQuarter, y = LoanOriginalAmount), 
  ...
  geom_boxplot(aes(colour = EmploymentStatus), 
               outlier.colour = 'pink', outlier.shape = 4, outlier.size = 0.8) +
...
```{r echo=FALSE, Bivariate_Plots}
ggplot(aes(x = StatedMonthlyIncome, y = MonthlyLoanPayment), data = loan) +
...
ggplot(aes(x = LoanOriginationQuarter, y = LP_InterestandFees), 
  ...
  scale_x_discrete(limits = c('Q1 2006','Q2 2006','Q3 2006','Q4 2006','Q1 2007','Q2 2007','Q3 2007','Q4 2007','Q1 2008','Q2 2008','Q3 2008','Q4 2008','Q1 2009','Q2 2009','Q3 2009','Q4 2009','Q1 2010','Q2 2010','Q3 2010','Q4 2010','Q1 2011','Q2 2011','Q3 2011','Q4 2011','Q1 2012','Q2 2012','Q3 2012','Q4 2012','Q1 2013','Q2 2013','Q3 2013','Q4 2013','Q1 2014')) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) 
